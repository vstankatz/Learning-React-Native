...
import { ScrollView, StyleSheet, Text, View, Button, TextInput, FlatList, TouchableOpacity, Dimensions, Animated, Easing } from 'react-native';
...
export default function App() {
  ...
  const [screenSize, setScreenSize] = useState({height: screenWidth, width: screenHeight})
  ...
  return (
    ...
    <Text>Width: {screenSize.width} Height: {screenSize.height}</Text>
